...
6.	Installing Pokémon FireRed Universal 3D
==================================================
To install Pokémon FireRed Universal 3D, extract the file at the desktop and place it to the respective folder.

After completing the above step,
1.	Open Pokémon 3D Game.
2.	Press the Pokéball button on the top right.
3.	Check that “Pokémon FireRed Universal 3D” is activated and is on top of any font pack. 
4.	Apply it if they are not activated by default.
5.	Restart the game to take effect.

To remove Pokémon FireRed Universal 3D, delete the content pack and gamemode folder.
...
P_G_S_C Rip From: PocketMonstersMusic
...
All the other unimplemented Pokémon: Darkfire
NPC drawn by: Smasher, Wesley
NPC Rip From: Pokémon Essentials v13 2012-12-02 (Flameguru, Poccil (Peter O.), Maruno)
