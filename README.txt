...
2.	About
==================================================
Pokémon Universal 3D is a GameMode to the Pokémon 3D game.

All the resources that are available in this game are made by me unless otherwise stated.
I am not allowed to add other’s content pack in this game unless permission is granted from the owner.

==================================================
3.	Contacting
==================================================
The easiest way to contact me privately is by PM.
...
5.	Installing and running Pokémon 3D
==================================================
Installing the engine is straight forward.
Go to http://pokemon3d.net/downloads/ and download the launcher to install the engine.
